...
Ansible would not be that popular if it would not bring a solution that enables ZEN to the inventory by calling the vCenter API.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwOTc2MTY3MCwtMTAzMzg2ODE1NywtMj
